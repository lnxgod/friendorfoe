        ...
        LazyColumn(
            ...
            item {
                SectionCard(title = "Category Colors") {
                    ...
                    CategoryLegendRow(Color(0xFFE65100), "Government", "Government aircraft", "GOV")
                    CategoryLegendRow(Color(0xFFE65100), "Law", "Sheriff / police aircraft", "LAW")
                    CategoryLegendRow(Color(0xFFD32F2F), "Fire", "Fire / rescue aircraft", "FIRE")
                    CategoryLegendRow(Color(0xFFE91E63), "EMS", "Medical / medevac aircraft", "EMS")
                    CategoryLegendRow(Color(0xFF1565C0), "Public Safety", "Confirmed public-safety aircraft", "PS")
...
private fun SectionCard(title: String, content: @Composable () -> Unit) {
    FofSection(title = title) { content() }
}
