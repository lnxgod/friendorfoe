...
/* Backend scanner policy: retain both behavioral threat result kinds. */
#ifdef FOF_BACKEND_FIRMWARE
#define FOF_SERIAL_SKIMMER_DETECTION_ENABLED 1
#else
#define FOF_SERIAL_SKIMMER_DETECTION_ENABLED 0
#endif
