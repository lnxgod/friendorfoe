...
#define BACKEND_EMBEDDED_CRC UINT32_C(0xB42AE8FC)
#else
#define BACKEND_EMBEDDED_CRC UINT32_C(0xF03A379D)
#endif
#else
...
#if defined(FOF_BACKEND_PROFILE_BADGE_LITE)
#define BACKEND_EMBEDDED_CRC UINT32_C(0xD972A7E7)
#else
#define BACKEND_EMBEDDED_CRC UINT32_C(0x86C70497)
#endif
#endif
