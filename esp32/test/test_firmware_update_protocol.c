...
void test_firmware_update_protocol_carries_crc_and_target_metadata(void)
{
    ...
    TEST_ASSERT_EQUAL_STRING("app_project", JSON_KEY_FW_PROJECT);
    TEST_ASSERT_EQUAL_STRING("hardware_type", JSON_KEY_FW_HARDWARE);
    TEST_ASSERT_EQUAL_STRING("sha256", JSON_KEY_FW_SHA256);
    TEST_ASSERT_EQUAL_STRING("generation", JSON_KEY_FW_GENERATION);
    TEST_ASSERT_EQUAL_STRING("allow_same_version", JSON_KEY_FW_ALLOW_SAME);
