...
- Android app: `0.64.62-privacy-oui`
- Backend: `0.64.62-privacy-oui`
- FoF Badge firmware: `0.64.62-badge-privacy-oui`
- Production S3 firmware: `0.64.62-privacy-oui`
...
`0.64.62-badge-privacy-oui` is the current badge privacy/OUI release,
...
- Uplink and scanners report `0.64.62-badge-privacy-oui` after the matching badge
  images are flashed.
