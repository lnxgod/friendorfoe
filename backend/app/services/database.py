...
def _ensure_detection_columns(sync_conn) -> None:
    ...
    wanted = {
        ...
        "scanner_slot": "INTEGER",
        "scanner_slots_seen": "INTEGER",
        "ble_threat_kind": "INTEGER",
        "ble_prompt_family_mask": "INTEGER",
        "ble_unique_macs": "INTEGER",
        "ble_observation_count": "INTEGER",
        "ble_serial_service_uuid": "INTEGER",
        "ble_threat_evidence_mask": "INTEGER",
